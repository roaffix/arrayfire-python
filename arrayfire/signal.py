...
def convolve1(signal, kernel, conv_mode=CONV_MODE.DEFAULT, conv_domain=CONV_DOMAIN.AUTO):
    ...
    output = Array()
    safe_call(
        backend.get().af_convolve1(c_pointer(output.arr), signal.arr, kernel.arr, conv_mode.value, conv_domain.value))
    return output
...
def convolve2(signal, kernel, conv_mode=CONV_MODE.DEFAULT, conv_domain=CONV_DOMAIN.AUTO):
    ...
    output = Array()
    safe_call(
        backend.get().af_convolve2(c_pointer(output.arr), signal.arr, kernel.arr, conv_mode.value, conv_domain.value))
    return output
...
def convolve3(signal, kernel, conv_mode=CONV_MODE.DEFAULT, conv_domain=CONV_DOMAIN.AUTO):
    ...
    output = Array()
    safe_call(
        backend.get().af_convolve3(c_pointer(output.arr), signal.arr, kernel.arr, conv_mode.value, conv_domain.value))
    return output
